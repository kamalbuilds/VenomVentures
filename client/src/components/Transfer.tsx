...
export default function Transfer() {
  ...
  const client = new TonClient({
    network: { endpoints: ['https://gql-devnet.venom.network/graphql'] },
  });
  ...
  return (
    <main className="flex  flex-col items-center justify-center my-30 p-20">
      ...
      <div className="flex flex-col items-center w-[588px] mt-[10%]">
        <input
          className="shadow appearance-none border rounded w-80 py-2 px-3 bg-black text-white focus:outline-none  mb-8"
          id="message"
          type="text"
